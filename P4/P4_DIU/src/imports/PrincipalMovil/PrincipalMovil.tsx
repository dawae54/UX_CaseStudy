import svgPaths from "./svg-yffjhl8tfx";
    ...
    <div className="relative shrink-0 w-full" data-name="Botones">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[20px] items-center justify-center px-[10px] relative size-full">
          <div className="bg-[#dff2e2] relative rounded-[45px] shrink-0 w-full" data-name="Button">
...
function MainContent() {
  return (
    <div className="col-[1/span_3] justify-self-stretch relative row-2 self-center shrink-0" data-name="Main Content">
      ...
      <div className="relative shrink-0 w-full" data-name="Carrusel">
        <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex flex-col gap-[32px] items-center justify-center px-[16px] relative size-full">
            <div className="bg-white max-w-[363px] relative rounded-[12px] shrink-0 w-full" data-name="Card">
...
function Frame4() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full">
      <div className="aspect-[1240/1240] relative shrink-0 w-full" data-name="image 1">
...
export default function PrincipalMovil() {
  return (
    <div className="bg-[#fffdf3] gap-x-[10px] grid grid-cols-[____minmax(0,1fr)_minmax(0,1fr)_minmax(0,1fr)_fit-content(100%)] grid-rows-[repeat(4,fit-content(100%))] relative size-full" data-name="Principal Movil">
      <MainContent />
      <Frame1 />
      <Frame2 />

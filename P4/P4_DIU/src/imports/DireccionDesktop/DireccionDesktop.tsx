...
export default function DireccionDesktop() {
  return (
    <div className="bg-[#fffdf3] content-stretch flex flex-col items-start p-[32px] relative size-full" data-name="Direccion Desktop">
      <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px relative w-full" data-name="Formulario Direccion">

import svgPaths from "./svg-ctbuizq18s";
...
function Container30() {
  return (
    <div className="bg-[#f9fafb] h-[116px] not-italic relative rounded-[10px] shrink-0 w-full whitespace-nowrap" data-name="Container">
...
export default function ReservasMovil() {
  return (
    <div className="bg-[#fffdf3] gap-x-[10px] grid grid-cols-[____minmax(0,1fr)_minmax(0,1fr)_minmax(0,1fr)_fit-content(100%)] grid-rows-[____fit-content(100%)_fit-content(100%)_minmax(0,1fr)_minmax(0,1fr)] relative size-full" data-name="Reservas Movil">
      <div className="col-[1/span_3] justify-self-stretch relative row-[3/span_2] self-stretch shrink-0" data-name="Formulario Reserva">
      ...
      <div className="col-[1/span_3] drop-shadow-[0px_10px_7.5px_rgba(0,0,0,0.1),0px_4px_3px_rgba(0,0,0,0.1)] justify-self-stretch relative rounded-[14px] row-2 self-start shrink-0" data-name="Seleccion fecha">
        <div className="flex flex-col items-center justify-center size-full">
      ...
      <div className="bg-[#e7e8e8] col-4 content-stretch flex flex-col items-start overflow-clip relative row-[2/span_3] self-stretch shrink-0 w-[20px]" data-name="Vertical Scrollbar">
        <div className="bg-[#807d6e] h-[100px] relative shrink-0 w-full" />
      </div>
      <div className="bg-[#fefadd] col-[1/span_4] h-[50px] justify-self-stretch relative row-1 shrink-0" data-name="Navigation">
        <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex gap-[8px] items-center justify-center px-[8px] py-[4px] relative size-full">
            ...
            <p className="font-['Quicksand:Bold',sans-serif] font-bold leading-[40px] relative shrink-0 text-[#f2a5a9] text-[31px] whitespace-nowrap">PokePoké</p>
            <Espacio />
            <div className="overflow-clip relative shrink-0 size-[32px]" data-name="menu">
              <div className="absolute bottom-1/4 left-[12.5%] right-[12.5%] top-1/4" data-name="Vector">
                <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 16">
                  <path d={svgPaths.p3bd073c0} fill="var(--fill-0, #F2A5A9)" id="Vector" />
                </svg>
              </div>
            </div>
          </div>

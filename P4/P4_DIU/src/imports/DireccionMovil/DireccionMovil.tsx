...
export default function DireccionMovil() {
  return (
    <div className="bg-[#fffdf3] content-stretch flex flex-col items-start p-[32px] relative size-full" data-name="Direccion Movil">
